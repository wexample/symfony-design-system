...
import WithRovingFocusKeyboardVueMixin from "../../js/Vue/WithRovingFocusKeyboardVueMixin";
...
const translated = buildTranslatedBindings({
  resolvedPlaceholder: [
    'placeholder',
    'WexampleSymfonyDesignSystemBundle.vue.search.search-box::placeholder'
  ],
  resolvedEmptyLabel: [
    'emptyLabel',
    'WexampleSymfonyDesignSystemBundle.vue.search.search-box::empty'
  ],
  resolvedPendingLabel: [
    'pendingLabel',
    'WexampleSymfonyDesignSystemBundle.vue.search.search-box::pending'
  ]
});
...
export default {
  template: '#vue-template-wexample-symfony-design-system-bundle-vue-search-search-box',
