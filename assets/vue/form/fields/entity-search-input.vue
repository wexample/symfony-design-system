...
const translated = buildTranslatedBindings({
  resolvedClearLabel: [
    'clearLabel',
    'WexampleSymfonyDesignSystemBundle.vue.form.fields.entity-search-input::clear'
  ]
});
...
export default {
  ...
  template: '#vue-template-wexample-symfony-design-system-bundle-vue-form-fields-entity-search-input',
