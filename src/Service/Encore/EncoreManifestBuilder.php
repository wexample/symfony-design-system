...
namespace Wexample\SymfonyDesignSystem\Service\Encore;
...
class EncoreManifestBuilder
{
    ...
    {
        $pathsGroups = $this->parameterBag->has('design_system_packages_front_paths')
            ? $this->parameterBag->get('design_system_packages_front_paths')
            : [];
        $descriptors = [];
